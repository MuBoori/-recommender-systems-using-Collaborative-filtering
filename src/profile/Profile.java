...
public class Profile
{
	 ...
	 * Sort by Value
	 */
	public Map<Integer,Double> sortByValue(){
		return sortHashMapByValuesD(dataMap);
	}
	
	
	private LinkedHashMap<Integer, Double> sortHashMapByValuesD(Map<Integer, Double> dataMap2) {
		   List mapKeys = new ArrayList(dataMap2.keySet());
		   List mapValues = new ArrayList(dataMap2.values());
		   ...
		   while (valueIt.hasNext()) {
		       ...
		       while (keyIt.hasNext()) {
		           ...
		           String comp1 = dataMap2.get(key).toString();
